...
function drawText() {
  ...
  if (frameNumber < 300) {
    ...
    context.fillText(
      "everyday a day I cannot believe how lucky I am",
      canvas.width / 2,
      canvas.height / 2
    );
  ...
  if (frameNumber > 3000 && frameNumber < 99999) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        [
          "I love you so much hitali, more than",
      ...
      context.fillText(
        "I love you so much hitali, more than all the time and space in the universe can contain",
        canvas.width / 2,
        canvas.height / 2
      );
    }
